Shader "HDRP/Lit_TimeInteractable"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 PopulateSurfaceData(SurfaceDescriptionInputs IN)
            {
                ...
                //Unity_Multiply_float(_Multiply_CCE9D4BB_Out_2, float4 (0.5, 0.5, 0.5, 0.5), _Multiply_CCE9D4BB_Out_2);
            ...
            GraphVertexOutput vert(GraphVertexInput v)
            {
                ...
                o.WorldSpaceViewDirection = GetPrimaryCameraPosition().xyz - mul(GetObjectToWorldMatrix(), float4(v.vertex.xyz, 1.0)).xyz;
                return o;
            }
            ...
            float4 frag(GraphVertexOutput IN) : SV_Target
            {
                ...
                return all(isfinite(surf)) ? half4(surf.x, surf.y, surf.z, 1.0f) : float4(1.0f, 0.0f, 1.0f, 1.0f);
            }
